...
class PrestamosModel extends Query
{
    ...
    public function getPrestamos()
    {
        $sql = "SELECT 
            p.id AS id_prestamo,
            e.id, 
            CONCAT(e.nombre,' ', e.a_paterno, ' ', e.a_materno) AS estudiante,
            l.id, 
            l.titulo, 
            p.id_estudiante, 
            p.id_libro, 
            ...
            p.observacion, 
            p.estado 
            FROM estudiante e INNER JOIN libro l INNER JOIN prestamo p 
            ON p.id_estudiante = e.id WHERE p.id_libro = l.id";
    ...
    public function editarPrestamo($id){
        $sql = "SELECT 
            ...
            p.estado 
            FROM estudiante e INNER JOIN libro l INNER JOIN prestamo p 
            ON p.id_estudiante = e.id WHERE p.id_libro = l.id WHERE p.id = '$id'";
        $res = $this->select($sql);
        return $res;
    }
