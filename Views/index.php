...
<head>
    ...
    <!-- Main CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo base_url; ?>Assets/css/main.css?v1">
    <!-- Font-icon css-->
        ...
        <div class="login-box">
            <form class="login-form" id="frmLogin" onsubmit="frmLogin(event);">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="password" placeholder="Inserte su clave de administrador" id="clave" name="clave" required>
                </div>
