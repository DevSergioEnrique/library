...
<head>
    ...
    <title>Biblioteca N°20165</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Main CSS-->
    <link rel="icon" href="<?php echo base_url; ?>Assets/img/logo-20165.ico" type="image/x-icon">
    <link href="<?php echo base_url; ?>Assets/css/main.css?v1" rel="stylesheet" />
...
<body class="app sidebar-mini">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="<?php echo base_url; ?>Configuracion/admin">Biblioteca Virtual</a>
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user">
            <img src="<?php echo base_url; ?>Assets/img/logo-20165.png" alt="User Image" width="50">
            <div class="ml-3">
        ...
        <ul class="app-menu">
            ...
            <li><a class="app-menu__item" href="<?php echo base_url; ?>Materia"><i class="app-menu__icon fa fa-list-alt"></i><span class="app-menu__label">Categorías</span></a></li>
