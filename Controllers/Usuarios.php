...
class Usuarios extends Controller{
            ...
            if ($data[$i]['estado'] == 1) {
                if ($data[$i]['id'] != 1) {
                    ...
                    <div class"text-center">
                        ...
                        <button class="btn btn-primary" type="button" onclick="btnEditarAdmin(' . $data[$i]['id'] . ');"><i class="fa fa-pencil-square-o"></i></button>
                    </div>'; 
                }
            }else {
    ...
    public function validar()
    {
        ...
        if (empty($clave)) {
            ...
            $data = $this->model->getUsuario($hash);
            if ($data) {
                ...
                $msg = array('msg' => 'Contraseña incorrecta o inexistente', 'icono' => 'warning');
            }
        }
